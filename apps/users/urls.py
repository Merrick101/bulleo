...
from .views import profile_view, onboarding, test_onboarding, toggle_notifications, mark_all_notifications_read, update_username, update_email, update_password, update_notifications
